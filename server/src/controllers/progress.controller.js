import { Lesson, Course, Enrollment, LessonProgress } from '../models/index.js';
import { recalculateProgress } from '../services/progress.service.js';
...
const markLessonComplete = async (req, res, next) => {
  try {
    ...
    const { enrollment: updated, justCompleted } = await recalculateProgress(enrollment.id);
