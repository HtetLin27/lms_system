...
import { Enrollment, User, Course, Certificate } from '../models/index.js';
...
const buildCertificatePdf = ({
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.rect(0, 0, doc.page.width, doc.page.height).fill('#F8F6FF');
    doc
    ...
    doc.fontSize(13).text(`Issued: ${dateStr}`, { align: 'center' }).moveDown(0.5);
...
export { generateCertificate, generateVerifyCode };
